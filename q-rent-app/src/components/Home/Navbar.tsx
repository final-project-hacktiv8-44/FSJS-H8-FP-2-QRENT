      ...
      {user?.user?.role !== "customer" ? (
        <div className="px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex justify-between md:flex md:items-center md:justify-center md:gap-5">
              <Link
              ...
              <div className="dropdown dropdown-end mr-20">
                <div className="inline-block rounded-lg px-2 py-1 text-sm font-medium text-gray-900 transition-all duration-200 hover:bg-blue-100 hover:text-gray-900">
                  <button className="flex flex-row items-center gap-1">
                    ...
                    <img
                      className="rounded-[30%] w-[2rem] h-[2rem] object-cover"
                      src={user.user?.image}
            ...
            <div className="hidden md:flex md:items-center md:justify-center md:gap-5">
              ...
              <div className="dropdown dropdown-end mr-20">
                <div className="inline-block rounded-lg px-2 py-1 text-sm font-medium text-gray-900 transition-all duration-200 hover:bg-blue-100 hover:text-gray-900">
                  <button className="flex flex-row items-center gap-1">
                    <img
                      className="rounded-[50%] w-[2rem] h-[2rem]"
                      src={user.user.image}
                      alt={user.user.username}
                    />
                    Profile
